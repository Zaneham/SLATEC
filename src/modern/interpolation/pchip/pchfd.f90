...
PURE SUBROUTINE PCHFD(N,X,F,D,Incfd,Skip,Ne,Xe,Fe,De,Ierr)
  ...
  !   251216  Eliminated GOTO 500 per MODERNISATION_GUIDE.md S1. (ZH)
  ...
  IF( .NOT. (Skip) ) THEN
    ...
    ELSE
      ...
      IF( i <= N ) THEN
        ...
        ! X-array not strictly increasing (was GOTO 500)
  ...
  !
  400  RETURN
  ! (Label 500 removed - error handled inline after loop)
  RETURN
  !
