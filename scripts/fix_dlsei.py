#!/usr/bin/env python3
"""Fix GOTO in dlsei.f90 - LSEI constrained least squares"""

filepath = 'C:/dev/slatec-modern/src/modern/approximation/dlsei.f90'

with open(filepath, 'r') as f:
    content = f.read()

# Add revision history - find revision section
...
# Replace GOTO 100 with RETURN - it just jumps to end
...
print('dlsei.f90: GOTO 100 eliminated!')
