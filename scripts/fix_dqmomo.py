#!/usr/bin/env python3
"""Fix GOTO in dqmomo.f90 - QUADPACK modified Chebyshev moments"""

filepath = 'C:/dev/slatec-modern/src/modern/diff_integ/quadpack/dqmomo.f90'
...
# Replace GOTO 100 with IF construct - the GOTO skips RH computation
...
print('dqmomo.f90: GOTO 100 eliminated!')
