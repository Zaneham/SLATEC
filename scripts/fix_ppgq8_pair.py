#!/usr/bin/env python
"""Fix GOTO 100/200 in dppgq8.f90 and ppgq8.f90 - adaptive quadrature with piecewise poly.
...
files = [
    ('C:/dev/slatec-modern/src/modern/diff_integ/dppgq8.f90', 'DP', 'DPPGQ8'),
    ('C:/dev/slatec-modern/src/modern/diff_integ/ppgq8.f90', 'SP', 'PPGQ8'),
]
